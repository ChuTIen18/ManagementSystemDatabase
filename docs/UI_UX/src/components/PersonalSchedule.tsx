...
export function PersonalSchedule() {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Lịch làm việc cá nhân - Tháng 9/2025</CardTitle>
          <CardDescription>
        ...
        <CardContent className="space-y-4">
          {futureApprovedSchedule.length > 0 ? (
            <>
                  ...
                  {futureApprovedSchedule.map((schedule) => {
                    ...
                    return (
                      <div key={schedule.id} className="flex items-center space-x-2">
                        ...
                        />
                        <Label htmlFor={shiftId} className="flex-1">
              ...
              <div>
                <Label htmlFor="leaveReason">Lý do xin nghỉ</Label>
                <Textarea
                  id="leaveReason"
                  value={leaveReason}
