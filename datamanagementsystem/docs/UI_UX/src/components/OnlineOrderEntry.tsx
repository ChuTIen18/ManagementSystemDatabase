...
export function OnlineOrderEntry() {
  ...
  const handleSubmit = () => {
    const newOrder: OnlineOrder = {
      ...
      items: formData.items.filter(item => item.name.trim()).map((item, index) => ({
        id: (index + 1).toString(),
        ...item
      })),
          ...
          <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-4">
                ...
                {formData.items.map((item, index) => (
                  <div key={index} className="grid grid-cols-12 gap-2 items-end">
                    ...
                    <div className="col-span-3">
                      ...
                      <Input
                        value={item.note}
                        onChange={(e) => updateFormItem(index, 'note', e.target.value)}
                        placeholder="Ghi chú"
                        size="sm"
                      />
                    </div>
              ...
              <div>
                ...
                <Select value={formData.paymentMethod} onValueChange={(value: 'cod' | 'paid') => setFormData(prev => ({ ...prev, paymentMethod: value }))}>
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-muted-foreground">{order.deliveryTime}</span>
                  </div>
                </div>
              </div>
        ...
        {orders.length === 0 && (
          <Card>
            <CardContent className="p-8 text-center">
              ...
              <p className="text-muted-foreground">Chưa có đơn hàng trực tuyến nào</p>
