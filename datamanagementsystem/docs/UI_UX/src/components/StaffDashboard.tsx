...
export function StaffDashboard() {
  ...
  const todayOrders = [
    { id: '#001', table: 'Bàn 3', items: 'Cappuccino x2, Croissant x1', total: 120000, status: 'completed' },
    { id: '#002', table: 'Bàn 7', items: 'Americano x1, Latte x1', total: 83000, status: 'processing' },
    { id: '#003', table: 'Bàn 2', items: 'Espresso x3', total: 105000, status: 'pending' }
  ];
  ...
  return (
    <div className="p-4 space-y-6 pb-24">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        ...
        {/* Lịch làm việc cá nhân (đăng ký lịch) */}
        ...
        {/* Xử lý hóa đơn (chỉ xuất báo cáo cuối ca và cập nhật dòng tiền) */}
        <TabsContent value="invoices">
          <StaffInvoiceProcessing />
        </TabsContent>

        {/* Báo cáo (nguyên liệu, đồ dùng, dòng tiền) */}
