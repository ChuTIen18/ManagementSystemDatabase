        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="mt-6 p-4 bg-blue-50 rounded-lg">
            ...
            <p className="text-blue-700 mt-2">
              Copy các components từ folder <code className="bg-blue-100 px-2 py-1 rounded">src/frontend/ui-reference/UI_UX/src/components</code> 
              vào <code className="bg-blue-100 px-2 py-1 rounded">src/frontend/web/renderer/components</code>
            </p>
          </div>
